...
public class Exercicio4 {
 public static void main(String[] args) {
	...
	System.out.println("Qual a área do cômodo a ser pintado?");
	...
	System.out.printf("A quantidade de latas de tintas a ser comprada é de %.0f e o valor a ser pago é R$ %.2f.",Math.ceil(tintas),valorTotal);
}
}
